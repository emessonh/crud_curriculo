  ...
  <form action="acoes/edita_usuario.php" method="POST" enctype="multipart/form-data" class="needs-validation container" novalidate>
    ...
    <div class="row g-12">
      ...
      <div class="col-sm-12">
        ...
        <input type="text" class="form-control" id="nome" name="nome" placeholder="" value="<?= $_SESSION['nome']; ?>" required>
      ...
      <div class="col-sm-12">
        ...
        <input type="text" class="form-control" id="nacionalidade" name="nacionalidade" placeholder="" value="<?= $_SESSION['nacionalidade']; ?>" required>
        <div class="invalid-feedback">
      ...
      <div class="col-md-12">
        ...
        <input type="number" class="form-control" id="idade" name="idade" min="10" max="120" step="1" value="<?= $_SESSION['idade']; ?>"required>
        <div class="invalid-feedback">
          Informe a sua idade.
        </div>
      </div>
      ...
      <div class="col-12">
        ...
        <input type="text" class="form-control" id="endereco" name="endereco" placeholder="" value="<?= $_SESSION['endereco']; ?>" required>
        <div class="invalid-feedback">
      ...
      <div class="col-md-12">
        ...
        <input type="text" class="form-control" id="celular" name="celular" placeholder="(99) 99999-9999" value="<?= $_SESSION['celular']; ?>"required>
        <div class="invalid-feedback">
      ...
      <div class="col-12">
        ...
        <div class="input-group has-validation">
          ...
          <input type="text" class="form-control" id="email" name='email' placeholder="email@provedor.com" value="<?= $_SESSION['email']; ?>"required>
        <div class="invalid-feedback">
            Digite o seu e-mail.
          </div>
        </div>
      ...
      <br>
      <button class="w-100 btn btn-primary btn-lg" type="submit" name="bt_atualizar_dados">
      Atualizar dados
      </button>
